 ...
 * every time (0.8.0 — it used to be a ceiling). The reason the number
 * exists at all is that choosing between real options is a stronger voice
 * signal than edit distance ever was: the user tells us which approach is
 * theirs by picking one, in a gesture they were going to make anyway. Edit
 * distance measured how much they retyped, which across 46 drafted leads
 * was recorded twice.
 */
export const DRAFT_OPTIONS = STYLES.length;
