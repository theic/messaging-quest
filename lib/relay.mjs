...
//     clothes. The doctrine is enforced at the call sites in bin/mq.mjs and
...
// MQ_RELAY env var — that a broker exists.
...
/**
 * The CLI side: hand one URL to the broker named by MQ_RELAY and wait.
