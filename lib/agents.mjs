...
const PROPOSAL = {
  ...
  properties: {
    ...
    places: { type: "array", items: { type: "string" }, description: "Community names, without a platform prefix, where people with this problem ask each other for help — communities, not apps, networks or chat services. Best guess, at most six." },
