...
import { existsSync, readFileSync, writeFileSync, join, basename } from "./fs.mjs";
...
export function readOne(dir, file) {
  ...
  return { ...m, body, exists, filled: filled(body, m.seed), bytes: new TextEncoder().encode(body).length };
}
