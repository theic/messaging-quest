...
--disp:"Bricolage Grotesque","Atkinson Hyperlegible","Segoe UI Variable Display","Segoe UI",system-ui,-apple-system,sans-serif;
--sans:"Atkinson Hyperlegible","Segoe UI Variable Text","Segoe UI",system-ui,-apple-system,"Helvetica Neue",Arial,sans-serif;
--px:"Press Start 2P",ui-monospace,"Cascadia Code","SF Mono",Menlo,Consolas,monospace;
...
body{margin:0;background:var(--page) radial-gradient(var(--dot) 1px,transparent 1.4px) 0 0/7px 7px;color:var(--ink);font:16px/1.6 var(--sans);text-rendering:optimizeLegibility}
...
header .who{font:13px var(--mono);color:var(--ink3)}
nav{display:flex;flex-wrap:wrap;gap:4px;padding:10px 18px;border-bottom:1.5px solid var(--rule);align-items:center}
nav a{padding:9px 11px 8px;text-decoration:none;color:var(--ink2);font:700 12.5px/1 var(--sans);letter-spacing:.07em;text-transform:uppercase;border:1.5px solid transparent}
...
.said{white-space:pre-wrap;font-size:15.5px;line-height:1.6;border-left:3px solid var(--ink);padding-left:14px;color:var(--ink2);max-height:22em;overflow:auto}
.meta{font:13px var(--mono);color:var(--ink3);margin-bottom:10px}
...
code,kbd{font:14px var(--mono);background:var(--soft);border:1px solid var(--rule2);padding:1px 5px}
.empty{text-align:center;padding:42px 20px;color:var(--ink2)}
.note{background:var(--hi);border:1.5px solid var(--ink);border-top:6px solid var(--lime);padding:14px 16px;margin:0 0 20px;font-size:15.5px}
...
label{display:block;font-size:14.5px;color:var(--ink2);margin:0 0 6px}
.field{margin:0 0 16px}
.tabs{display:flex;gap:4px;flex-wrap:wrap;margin:0 0 18px;border-bottom:1.5px solid var(--rule);padding-bottom:10px}
.tabs a{font:700 12.5px/1 var(--sans);letter-spacing:.07em;text-transform:uppercase;padding:9px 11px 8px;text-decoration:none;color:var(--ink2);border:1.5px solid transparent}
...
.strip .what{font-weight:700} .strip .note{background:none;border:0;padding:0;margin:0;color:var(--ink2);font-size:13.5px;
...
.step{font:700 11.5px/1 var(--sans);letter-spacing:.06em;text-transform:uppercase;padding:7px 10px 6px;border:1.5px solid var(--rule);color:var(--ink3)}
...
th{text-align:left;font:700 11.5px var(--sans);text-transform:uppercase;letter-spacing:.07em;
  color:var(--ink3);border-bottom:1.5px solid var(--ink);padding:8px 10px 8px 0}
td{padding:11px 10px 11px 0;border-bottom:1px solid var(--rule2);vertical-align:top}
td,th{overflow-wrap:anywhere}
tr:last-child td{border-bottom:0}
.pill{font:12px var(--mono);padding:3px 7px;border:1px solid var(--rule);background:var(--soft);color:var(--ink2)}
.log{font:13px/1.55 var(--mono);background:var(--panel);border:1.5px solid var(--ink);
